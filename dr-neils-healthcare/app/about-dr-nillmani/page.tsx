...
// PRIMARY KEYWORD: homeopath consultant Houston
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <DisplayHeading as="h1">
                Dr. Nill Mani<br />
                <em>Homeopath Consultant</em><br />
                in Houston
              </DisplayHeading>

              <p className="text-xl text-ink-secondary leading-relaxed">
                Trained in classical homeopathy and certified in herbal medicine at Stanford, with a Bachelor of Electropathy Medicine and Surgery (BEMS) and a PhD in Biomedical Engineering from IIT, Dr. Nill Mani brings unhurried, individualized care to Houston's homeopathy community.
              </p>
            ...
            <BentoCard colSpan={4} rowSpan={2} variant="default">
              <div className="h-full flex flex-col justify-center space-y-4">
                ...
                <div className="space-y-3 text-base text-ink-secondary">
                  ...
                  <p>
                    Dr. Nill Mani holds a Bachelor of Electropathy Medicine and Surgery (BEMS) and a PhD in Biomedical Engineering from IIT, and is Stanford-certified in herbal medicine — a multi-disciplinary foundation applied to classical homeopathy practice.
                  </p>
                  <p>
                    With [X] years in clinical practice, Dr. Nill Mani specializes in [top 2-3 areas: e.g., women's hormonal health, pediatric care, chronic skin conditions].
                  </p>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-ink-secondary leading-relaxed">
              <p className="text-xl text-ink-primary">
                Dr. Nill Mani practices <strong>classical homeopathy</strong> — a centuries-old approach that differs fundamentally from how most modern medicine works.
              </p>
              ...
              <p>
                This is why the consultation takes 30 minutes. Dr. Nill Mani needs to understand not just your symptoms, but <em>you</em>: your sleep patterns, your stress triggers, what you crave, what makes you feel better or worse, your childhood illnesses, your family history. Classical homeopathy works by matching the remedy to the totality of who you are.
              </p>

              <p>
                <strong>One remedy at a time.</strong> Dr. Nill Mani doesn't prescribe 14-supplement protocols or layered combinations. Classical homeopathy means selecting the single best-matched remedy, giving it time to act, and observing what shifts. If the remedy is correct, your body knows what to do with it. If it's not, we adjust. This careful, individualized approach is how homeopathy has been practiced for 200 years.
              </p>

              <p>
                <strong>Honesty over overselling.</strong> Dr. Nill Mani will tell you when homeopathy isn't the right fit. Some conditions need conventional care. Some need a specialist. Some need emergency intervention. Homeopathy works best for chronic, recurring concerns where your body needs support recalibrating, not suppression. If you need labs, imaging, or a prescription, Dr. Nill Mani will refer you to the right provider.
              </p>

              <p>
                <strong>Working alongside your other doctors.</strong> Dr. Nill Mani doesn't replace your primary care physician, your psychiatrist, or your specialist. Homeopathy works <em>alongside</em> conventional care. Many patients continue their prescriptions while working with homeopathy. There are no known drug interactions with homeopathic remedies, and Dr. Nill Mani will never tell you to stop a medication without consulting your prescriber.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full bg-bg-page py-16 md:py-20">
        <div className="container mx-auto max-w-7xl px-5 md:px-8">
          <div className="max-w-3xl mx-auto bg-accent-soft border border-accent/20 rounded-3xl p-12 text-center space-y-6">
            <DisplayHeading as="h2">
              Have a question for <em>Dr. Nill Mani</em><br />before booking?
            </DisplayHeading>

            <p className="text-lg text-ink-secondary leading-relaxed">
              Not every situation is right for homeopathy, and that's okay. If you're unsure whether your concern is a good fit, email Dr. Nill Mani directly.
            </p>
