...
export default function HowItWorksPage() {
  const processSteps = [
    ...
    },
    {
      ...
      description:
        "Join Dr. Nill Mani for a half hour via secure, HIPAA-compliant video. This isn't a rushed 12-minute appointment. Dr. Nill Mani will ask detailed questions about your current symptoms, your medical history, your sleep patterns, your stress, what you crave, what you can't stand, what time of day you feel best. Every detail helps match the right remedy to your unique pattern. Most patients tell us this is the first time a healthcare provider has actually listened.",
    },
    {
      number: "03",
  ...
  const processFAQs = [
    ...
    },
    {
      ...
      answer:
        "Complete the intake form (you'll receive it after booking), find a quiet private space for telehealth, have your medication list ready, and think about your symptoms — what makes them better, what makes them worse, when they're strongest. Don't stress about what to say — Dr. Nill Mani will guide the conversation.",
    },
    {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-bg-card border border-border-soft rounded-2xl p-8 shadow-[var(--shadow-card)]">
                ...
                <p className="text-base text-ink-secondary leading-relaxed">
                  Dr. Nill Mani reviews your case and writes a detailed plan: which remedy (or remedies), dosing instructions, what to expect, what to watch for, and when to follow up. You'll receive this via email within 48 hours.
                </p>
              </div>
        ...
        <div className="container mx-auto max-w-7xl px-5 md:px-8">
          <div className="bg-bg-card-feature text-ink-on-dark rounded-3xl p-12 md:p-16 text-center space-y-6">
            ...
            <p className="text-sm text-ink-on-dark/70 pt-4">
              Still have questions? Email [Email] — Dr. Nill Mani personally replies within one business day
            </p>
          </div>
        </div>
      </section>
