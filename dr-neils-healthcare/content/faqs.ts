...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "No. A naturopath is a broader practitioner who may use herbs, nutrition, supplements, hydrotherapy, and sometimes homeopathy. A homeopath consultant like Dr. Nill Mani uses one carefully selected homeopathic remedy at a time. We do not prescribe herbs, supplements, or vitamins. We do not run lab tests. We do one thing — homeopathy — and we do it carefully.",
    category: "about-homeopathy",
  },
  ...
  {
    question: "Is Dr. Nill Mani a medical doctor?",
    answer:
      "Dr. Nill Mani is Stanford-certified in herbal medicine and holds a Bachelor of Electropathy Medicine and Surgery (BEMS) and a PhD in Biomedical Engineering from IIT. Dr. Nill Mani is not licensed to diagnose disease, prescribe pharmaceuticals, or order labs in Texas, and works alongside your primary care physician and specialists. Nothing on this website is medical advice, and a homeopathic consultation is not a substitute for the care of a licensed medical doctor.",
    category: "practice",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Children typically respond beautifully to homeopathy — it's gentle, non-toxic, and well-tolerated. Dr. Nill Mani sees kids regularly for ear infections, eczema, anxiety, behavioral concerns, and recurring colds. Pediatric consultations include time with the parent as well as the child, when developmentally appropriate.",
    category: "conditions-safety",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sometimes. A brief intensification of symptoms, called a \"homeopathic aggravation,\" can occur in the first few days after taking a remedy. It's typically short-lived and is generally considered a sign that the remedy is acting. Dr. Nill Mani will prepare you for what to watch for and what's normal.",
    category: "conditions-safety",
  },
];
